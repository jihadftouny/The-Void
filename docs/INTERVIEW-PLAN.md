...
| G1, G3–G8, G11–G14, G16–G31, G33, G34 | **Bugs** — fixes specified in FINDINGS §4 (**29 of 32**). ⚠ **G2 has no fix yet; `G32` needs a decision** (wire `proficiency` and re-sim, or delete it) |
