...
> **Thirty-eight rows carry `BUG` status** (of **41** — G7, G9 and G10 are `DECIDED`). **Thirty-six
...
### Found 2026-08-30 by discrepancy pass 10A — the ONLY finding in an otherwise NIL engine audit
