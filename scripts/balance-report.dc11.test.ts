// D9, ONE BATCH — the baseline at an injected illusion DC of 11.
...
describe('D9 — the baseline at an injected illusion DC of 11', () => {
  it(
    ...
    () => {
      ...
      ).toEqual(inputs.dcRows.find((r) => r.dc === 11)!.report);
    },
    300_000,
  );
});
