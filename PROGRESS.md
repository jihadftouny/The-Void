...
| N1 — Desktop shell + local-model spike | 🔄 spike GREEN + Electron shell built + headless smoke PASS (4B in Electron @ 90 tok/s Vulkan); awaiting your visual `npm run desktop` — branch `spike/n1-local-llm` |
